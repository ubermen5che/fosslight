...
<script>
    ...
    $(document).ready(function()
    {
        ...
        $("#list").jqGrid({
            datatype: "local",
            data : jsonData,
            colNames:['id', 'License Name','License Type','Restriction','Obligation','Short Identifier','Nicknames','Web site for the license','License Text',
            ...
            colModel: [
                ...
                { name: 'licenseNicknames', index:'licenseNicknames', width: 150, align: 'left'},
